...
{
    public partial class Viewings_ViewUserControl : UserControl
    {
        ...
        public Viewings_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Viewings_ViewForm_Load;
            this.Disposed += Viewings_ViewForm_Disposed;
        ...
        private void Viewings_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Viewings_ViewForm_Load;
            this.Disposed -= Viewings_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Viewings_AddEditForm(DBT_Viewings.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Viewings_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Viewings.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Viewings_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
        ...
        private void UpdateTable()
        {
            ...
            dataGridView.Columns.Add("ViewingId", "№");
            dataGridView.Columns.Add("RequestId", "Заявка");
            dataGridView.Columns.Add("PropertyId", "Недвижимость");
            dataGridView.Columns.Add("ScheduledTime", "Дата");
            dataGridView.Columns.Add("Status", "Статус");
            dataGridView.Columns.Add("Notes", "Описание");
                ...
                using (var query = connection.CreateCommand())
                {
                    ...
                    using (var reader = query.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            var property = DBT_Properties.GetById(reader.GetInt32(2));
                            dataGridView.Rows[index].Cells[2].Value = $"{property.Type} - [{property.Address}]";
