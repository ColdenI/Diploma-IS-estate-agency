...
{
    public partial class Users_ViewUserControl : UserControl
    {
        ...
        public Users_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Users_ViewForm_Load;
            this.Disposed += Users_ViewForm_Disposed;
        ...
        private void Users_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Users_ViewForm_Load;
            this.Disposed -= Users_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Users_AddEditForm(DBT_Users.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Users_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Users.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Users_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
