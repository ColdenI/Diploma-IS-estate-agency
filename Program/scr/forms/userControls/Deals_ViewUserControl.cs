...
{
    public partial class Deals_ViewUserControl : UserControl
    {
        ...
        public Deals_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Deals_ViewForm_Load;
            this.Disposed += Deals_ViewForm_Disposed;
        ...
        private void Deals_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Deals_ViewForm_Load;
            this.Disposed -= Deals_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new Deals_AddEditForm(DBT_Deals.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)).ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new Deals_AddEditForm().ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Deals.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Deals_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
